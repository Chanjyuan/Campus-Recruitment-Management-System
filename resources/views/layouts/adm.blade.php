                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="javascript:void(0)" data-toggle="dropdown"
                                ...
                                <img src="../assets/images/users/admin.jpg" alt="user" class="rounded-circle border border-light"
                                    width="40">
                            ...
                            <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                                ...
                                document.getElementById('admin-logout-form').submit();"><i data-feather="power"
            ...
            <div class="scroll-sidebar" data-sidebarbg="skin6">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link" href="/jobseekers"
                                aria-expanded="false"><i class="fas fa-graduation-cap"></i><span
                                    class="hide-menu">Manage Jobseekers
                                </span></a>
                        </li>
                        <li class="sidebar-item"> <a class="sidebar-link" href="/employers"
                            aria-expanded="false"><i class="fas fa-users"></i><span
                                class="hide-menu">Manage Employers
                            </span></a>
                        </li>
                        <li class="sidebar-item"> <a class="sidebar-link" href="/all-posted-jobs"
                            aria-expanded="false"><i class="fas fa-briefcase"></i><span
                                class="hide-menu">Posted Jobs
                            </span></a>
                        </li>
                        <li class="sidebar-item"> <a class="sidebar-link" href="/all-job-applications"
                            aria-expanded="false"><i class="fas fa-clipboard-list"></i><span
                                class="hide-menu">Job Applications
                            </span></a>
                        </li>
                        <li class="list-divider"></li>
                        <li class="nav-small-cap"><span class="hide-menu">Authentication</span></li>

                        <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="/change_password"
                        ...
                        <li class="sidebar-item"> 
                            ...
                            document.getElementById('admin-logout-form').submit();" aria-expanded="false"><i data-feather="log-out"
