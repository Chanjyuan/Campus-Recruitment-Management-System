        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header bg-primary">
                    <h4 class="page-title text-truncate text-white font-weight-medium mb-0">All Job Applications</h4>
                </div>
                <div class="card-body">
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                @if($application->status == 'Withdrawn')
                                    {!! Form::open(['action' => ['AdminController@removeApp', $application->id], 'method' => 'POST', 'style' => 'text-align:center']) !!}
                                        {{Form::hidden('_method', 'POST')}}
                                        {{Form::submit('Remove', ['class' => 'btn btn-outline-danger'])}}
                                    {!! Form::close() !!}   
                                @else
                                    <a class="btn btn-block btn-primary" href="/storage/resumes/{{$application->user->profile->resume}}" target="_blank">View Resume</a>
                                @endif
                                </td>
