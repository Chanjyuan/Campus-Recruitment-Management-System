...
<head>
    ...
    <title>Employer Register | UKM-crms</title>
    <!-- Custom CSS -->
        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center position-relative"
            ...
            <div class="auth-box row">
                ...
                <div class="col-lg-12 col-md-12 bg-white">
                    <div class="p-3">
                        <h2 class="mt-3 text-center"><img class="pr-2" src="/../assets/images/big/empreg.png" style="width: 10%" alt="wrapkit"> Employer | Register</h2>
                        {{-- <div class="text-center">
                            <img src="/../assets/images/big/icon.png" alt="wrapkit">
                        </div> --}}

                        {{-- <p class="text-center">Enter your email address and password to access admin panel.</p> --}}
                        <form class="mt-4" method="POST" action="{{ route('employer.register.submit') }}">
                            @csrf
                            <div class="row">
                                <div class="col-lg-6">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input id="company_name" type="text" class="form-control @error('company_name') is-invalid @enderror" name="company_name" value="{{ old('company_name') }}" required autocomplete="company_name" placeholder="Your Company Name" autofocus>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label class="text-dark" for="phone">Contact No.</label>
                                        <input id="phone" type="text" class="form-control @error('phone') is-invalid @enderror" name="phone" value="{{ old('phone') }}" required autocomplete="phone" placeholder="60##(#######)" autofocus>
                            ...
                            <div class="row d-flex justify-content-center">
                                <div class="col-lg-6 mt-4 text-center">
                                    Have an account?<br> <a href="/employer-login" class="text-primary float-left">Login Now</a>
...
<div class="container" style="margin-top: 79px;">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header bg-primary text-light">{{ __('Register | Employer') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('employer.register.submit') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" placeholder="example@domain.com" required autocomplete="email">
