...
<head>
    ...
    <title>Jobseeker Register | UKM-crms</title>
    <!-- Custom CSS -->
        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center position-relative"
            ...
            <div class="auth-box row">
                ...
                <div class="col-lg-12 col-md-12 bg-white">
                    <div class="p-3">
                        <h2 class="mt-3 text-center"><img class="pr-2" src="/../assets/images/big/default.jpg" style="width:10%" alt="wrapkit"> Jobseeker | Register</h2>
                        ...
                        <form class="mt-4" method="POST" action="{{ route('register') }}">
                            ...
                            <div class="row d-flex justify-content-center">
                                <div class="col-lg-6 mt-4 text-center">
                                    Have an account?<br> <a href="/login" class="text-primary float-left">Login Now</a>
...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Register | Jobseeker') }}</div>
